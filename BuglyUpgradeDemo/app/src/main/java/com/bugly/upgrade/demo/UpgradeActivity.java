	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		app.registUpgradeStateListener(new UpgradeStateListener() {
			...
			public void onUpgradeNoVersion(boolean isManual) {
				Log.i("buyly", "onUpgradeNoVersion");
			...
			{
				Log.i("buyly", "onDownloadCompleted");
...
//                Toast.makeText(getApplicationContext(), patchFileUrl, Toast.LENGTH_SHORT).show();
			...
			public void onDownloadReceived(long savedLength, long totalLength) {
				Log.i("buyly", "onDownloadReceived");
...
//                Toast.makeText(getApplicationContext(), patchFilePath, Toast.LENGTH_SHORT).show();
			...
			public void onDownloadFailure(String msg) {
				Log.i("buyly", "onDownloadFailure");
				AlertDownloadFail();
			}

			@Override
			public void onApplySuccess(String msg) {
				Log.i("buyly", "onApplySuccess");
